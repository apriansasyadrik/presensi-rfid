<div class="container-fluid px-6 py-8">
	...
	<div class="bg-white rounded-lg shadow-md p-6 mb-6">
		<form method="GET" action="<?= site_url('admin/laporan_siswa') ?>" class="grid grid-cols-1 md:grid-cols-3 gap-4">
			<div>
			...
			<div>
				...
				<select name="kelas_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" required>
	...
	<div class="flex gap-4 mb-4">
		<a href="<?= site_url('admin/laporan_siswa/export_excel?bulan=' . $bulan . '&kelas_id=' . $kelas_id) ?>" 
		   class="bg-green-500 text-white px-6 py-2 rounded-lg hover:bg-green-600">
			<i class="fas fa-file-excel mr-2"></i> Export Excel
		</a>
		<a href="<?= site_url('admin/laporan_siswa/export_pdf?bulan=' . $bulan . '&kelas_id=' . $kelas_id) ?>" 
		   target="_blank" class="bg-red-500 text-white px-6 py-2 rounded-lg hover:bg-red-600">
			<i class="fas fa-file-pdf mr-2"></i> Export PDF
		</a>
		<a href="<?= site_url('admin/laporan_siswa/rekap?bulan=' . $bulan . '&kelas_id=' . $kelas_id) ?>" 
		...
		<div class="overflow-x-auto">
			<table class="min-w-full divide-y divide-gray-200">
				...
				<tbody class="bg-white divide-y divide-gray-200">
					...
					<tr>
						<td class="px-6 py-4 whitespace-nowrap text-sm"><?= $row->nis ?></td>
	...
	<div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-yellow-800">
		<i class="fas fa-info-circle mr-2"></i> Pilih bulan dan kelas untuk menampilkan laporan.
	</div>
	<?php endif; ?>
</div>
