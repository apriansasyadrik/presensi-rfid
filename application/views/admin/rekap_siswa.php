<div class="container-fluid px-6 py-8">
	<div class="flex justify-between items-center mb-6">
		...
		<a href="<?= site_url('admin/laporan_siswa') ?>" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600">
	...
	<div class="bg-white rounded-lg shadow-md overflow-hidden">
		<div class="p-6 border-b border-gray-200">
			<h2 class="text-xl font-semibold">Rekap Absensi - <?= isset($kelas_info) ? $kelas_info->nama_kelas : '' ?></h2>
